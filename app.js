...
fetch("https://www.themealdb.com/api/json/v1/1/random.php")
  ...
  `;
    ...
    // Opening and closing Modal and animation
...
// Fetching API for Search Results
  ...
  fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?c=${catValue}`)
    ...
    .then((catMealData) => {
      ...
      for (i = 0; i < catMealData.meals.length; i++) {
        ...
        <button id="ingred">Ingredients</button>
      </div>`;
        }
      } else {
...
// Ingredients for search result dishes
...
function handleCardClick(e) {
  fetch("https://www.themealdb.com/api/json/v1/1/lookup.php?i=" + e)
    ...
    `;
      ...
      // Modal opening and closing and aimation
